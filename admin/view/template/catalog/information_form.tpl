      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
              ...
              <option value="0" style="display:none">Select</option>
				  <?php
                    foreach ($informations as $information) {
                        echo '<option value="'.$information['information_id'].'" '.($parent_id == $information['information_id']? 'selected="selected"':'').'>'.$information['title'].'</option>';	
                        
						// Sub Category
                        if($information['sub_page_tree']) { 
                            foreach ($information['sub_page_tree'] as $subpage) {
                                echo '<option value="'.$subpage['information_id'].'" '.($parent_id == $subpage['information_id']? 'selected="selected"':'').'> - '.$subpage['title'].'</option>';	
                            }
                        } 
                    }
                  ?>
            ...
            <tr>
              <td><?php echo $entry_bottom; ?><span class="help">Only for first level</span></td>
              <td><?php if ($bottom) { ?>
