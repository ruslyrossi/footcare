	...
	private $error = array();
  	...
  	protected function getList() {
    	...
    	foreach ($results as $result) {
			...
			$this->data['coupons'][] = array(
				...
				'new_customer'     => ($result['new_customer'] == '1'? 'Yes' : ''),
  	...
  	protected function getForm() {
		...
		if (isset($this->request->post['customer_type'])) {
			...
			$this->data['customer_type'] = $coupon_info['customer_type'];
		} else {
      		$this->data['customer_type'] = '';
    	}
		
		if (isset($this->request->post['customer_name_id'])) {
      		$this->data['customer_name_id'] = $this->request->post['customer_name_id'];
    	} elseif (!empty($coupon_info)) {
			$this->data['customer_name_id'] = $coupon_info['customer_name_id'];
		} else {
      		$this->data['customer_name_id'] = '';
    	}
		...
		if (isset($this->request->post['new_customer'])) {
      		$this->data['new_customer'] = $this->request->post['new_customer'];
    	} elseif (!empty($coupon_info)) {
			$this->data['new_customer'] = $coupon_info['new_customer'];
		} else {
      		$this->data['new_customer'] = '';
    	}
		...
		$customer_info = $this->model_sale_customer->getCustomer($this->data['customer_name_id']);
