...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if(!isset($this->request->get['route'])) {
			...
			$this->data['home_page'] = '';
		} else if (!isset($this->request->get['route']) || isset($this->request->get['route']) && $this->request->get['route'] == 'information/homepage') {
		...
		foreach ($this->model_catalog_information->getInformations() as $result) {
			if ($result['top'] == 1) {
				$this->data['informations'][] = array(
					...
					'sub_page_tree'  => $this->model_catalog_information->getSubInformationTree($result['information_id'])
				);
			}
		}
